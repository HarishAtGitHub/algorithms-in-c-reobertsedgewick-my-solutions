...
h4. Where did we use the union find ?
  
Yes we did . 
We did do *FIND* by searching for the elements group ID . and obtained A,B 
We did do *UNION* inside the if else block in step 3 .
It looks different as we just managed with a map .
